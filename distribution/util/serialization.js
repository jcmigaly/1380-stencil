...
function serializeFunction(object) {
  let stringFunc = object.toString()
  ...
  let funcObj = { type: 'function', parameters: params, body: bodyString }
  let transformedObject = {}
...
function serialize(object) {
  let transformedObject = serializeHelper(object)
...
function deserializeBaseCase(object) {
  ...
  if (object.__meta__specialType__.type === 'function') {
    let func = new Function(...object.__meta__specialType__.parameters, object.__meta__specialType__.body)
    return func
  }
}
...
function deserialize(string) {
  ...
  try {
    ...
    let deserializedObj = deserializeHelper(object)
